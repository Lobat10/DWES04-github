...
public class SaludoCookiesServlet extends HttpServlet {
	...
	public Cookie buscarCookie(String nombreCookie, HttpServletRequest request) {
		...
		if (cookies != null) {
			...
			cookieUsuario = cookieMap.get(nombreCookie);
		}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getMethod().equals("POST")) { // si se ha enviado el formulario...
			...
			if (usuario == "") {
				...
				nuevaCookieUsuario.setPath("/U4P09_Java_Cookies");
