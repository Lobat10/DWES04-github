...
public class MuestraVariablesServidor extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<h3>Parametros de inicialización del Servlet: "+ request.getServletPath()+"</h3>");
		out.println("<table style='border-collapse: collapse;margin:10px'>");
		out.println("<tr><td><b>Variable</b></td><td><b>Valor</b></td></tr>");
		...
		out.println("<h3>Parametros de inicialización del contexto: "+  contexto.getServletContextName()+"</h3>");
		out.println("<table style='border-collapse: collapse;margin:10px'>");
		out.println("<tr><td><b>Variable</b></td><td><b>Valor</b></td></tr>");
		...
		request.setAttribute("autor", "Adrián");
		
		out.println("<h3>Atributos de la request: </h3>");
		out.println("<table style='border-collapse: collapse;margin:10px'>");
		out.println("<tr><td><b>Variable</b></td><td><b>Valor</b></td></tr>");
		
		Enumeration <String> parametrosRequest2 =request.getAttributeNames();
		
		while(parametrosRequest2.hasMoreElements()) {
			String actual=parametrosRequest2.nextElement();
