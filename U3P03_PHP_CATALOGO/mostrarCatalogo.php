...
<form action="mostrarCatalogo.php" method="post">
		...
		<input type="text" name="vobra"> <input type="submit" name="enviar">
	</form>
...
if ($_SESSION['cod'] != '') {
    ...
    ?>
	<th>Codigo obra<a
				href='mostrarCatalogo.php?order=1&codigoAutor=<?php echo $varSesion ?>'>&#9650;</a><a
				href='mostrarCatalogo.php?order=2&codigoAutor=<?php echo $varSesion ?>'>
					&#9660;</a></th>
	<?php }else{?>
	<th>Codigo obra<a href='mostrarCatalogo.php?order=1'>&#9650;</a><a
				href='mostrarCatalogo.php?order=2'> &#9660;</a></th>
	<?php }?>
	<th>Nombre obra</th>
			<th>Duracion</th>
			<th>Imagen obra</th>
